...
function LargestFour(arr) { 
  ...
  //2. if arr.length < 4 ; calculate the sume of this numbers in array.
  if( arr.length < 4) {
  ...
  /*3A. to get four largest numbers firstly sort the given arr. 
   sort method always return comparing every element with next element.
   3B. then use .slice method to get first four numbers of sorted array.
   3C. then to get the sum of these four numbers, use .reduce method and return it. */
