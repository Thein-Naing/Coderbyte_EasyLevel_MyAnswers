...
function PalindromeSwapper(str) { 
    ...
    let word = str.slice(0, i) + str[i + 1] + str[i] + str.slice(i + 2);    /* 1. Create new word by swapping two adjacent characters in the string. 
                                                                                  Meaning: Create a palindrome by swapping the second and third characters of given str ----> str[i] + str[i+1] to str[i + 1] + str[i].
                                                                                  (Given Statemen: if a palindrome can be created by swapping two adjacent characters in the string.) */
