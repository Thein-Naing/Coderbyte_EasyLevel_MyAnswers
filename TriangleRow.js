...
function TriangleRow(num) { 
  ...
  /* Notes:  The Math.pow() static method returns the value of a base raised to a power. 
              Math.pow(x, y)  = x**y where x is base number and y is exponent.
 
  // 1 . Here case is Pascal's triangle.
  // 2.  The sum of the numbers in the nth row of Pascal's triangle is equal to 2^n (starting with row 0)
  // 3.  So simply use  Math.pow(2, num) methon and return it. */
...
console.log(TriangleRow(readline()));
