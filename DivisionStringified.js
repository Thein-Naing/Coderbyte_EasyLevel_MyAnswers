...
function DivisionStringified(num1,num2) { 
 ...
 /* 1. convert result of num1 divided by num2 to string using rounded with Math.round method,
    ...
    5. meaning: by using arr.splice method, if  i % 3 === 0  from backward index of result, ( we declare i-- in for loop)
       then delete elements will start from index at result.length -1.
