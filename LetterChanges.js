...
The index of the last character is string length - 1 */
  ...
  //3. use regex replace method by replacing "z" with "a" from str1.
  str2 = str1.replace(/z/gi,"a");

  //4.use regex replace method by replacing vowels by a function call with returning returning UpperCase vowels from str2.
