...
//5. add each letter of word into letters array. // letters.push(word[i]);
//6. Again take out each letter of word in reverse order and add into letters array. // reverseWord = reverseWord + letters.pop(); 
